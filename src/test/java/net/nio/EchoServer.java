...
public class EchoServer {
    public static SelectorConnectLoop connectionBell;
    public static SelectorConnectLoop readBell;
    ...
    public void startServer() throws IOException {
        // 准备好一个闹钟.当有链接进来的时候响.
        connectionBell = new SelectorConnectLoop();

        // 准备好一个闹装,当有read事件进来的时候响.
        readBell = new SelectorConnectLoop();
        ...
        socket.bind(new InetSocketAddress("localhost", 5209));
    ...
    // Selector轮询线程类  和SelectorReadLoop代码一样
    public class SelectorConnectLoop implements Runnable {
        private Selector selector;
        private ByteBuffer temp = ByteBuffer.allocate(1024);

        public SelectorConnectLoop() throws IOException {
    ...
    // Selector轮询线程类
    public class SelectorReadLoop implements Runnable {
        private Selector selector;
        private ByteBuffer temp = ByteBuffer.allocate(1024);

        public SelectorReadLoop() throws IOException {
            this.selector = Selector.open();
        }
